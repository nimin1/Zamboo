  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        'bubbly': ['Chewy', 'Fredoka', 'system-ui', 'sans-serif'],
        'logo': ['Bungee', 'Righteous', 'Chewy', 'system-ui', 'sans-serif'],
        'kids': ['Comic Neue', 'Kalam', 'Chewy', 'system-ui', 'sans-serif'],
        'funky': ['Righteous', 'Bungee', 'Fredoka', 'system-ui', 'sans-serif'],
      },
      fontSize: {
